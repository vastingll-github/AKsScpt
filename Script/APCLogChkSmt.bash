...
APLGEM[%X]="%X:接続ステータス "
APLGEM[%{Strings}i]="リクエストに含まれるヘッダー名の値"
APLGEM[%{Strings}o]="レスポンスに含まれるヘッダー名の値"
...
##########################################################################
#    デバッグ出力の初期化（デバッグ文の変数を広い、打ち出し時表示する    #
##########################################################################
PSV_INIT
